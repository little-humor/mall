package com.humor.product.configuration.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.humor.product.configuration.config.DruidDataSourceProperties;
...
public class DruidDataSourceConfiguration {
    ...
    public DataSource dataSource() {
        ...
        log.info("product datasource 初始化成功");
        return datasource;
    }
