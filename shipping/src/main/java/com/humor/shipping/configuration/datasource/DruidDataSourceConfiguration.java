package com.humor.shipping.configuration.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.humor.shipping.configuration.config.DruidDataSourceProperties;
...
public class DruidDataSourceConfiguration {
    ...
    public DataSource dataSource() {
        ...
        log.info("shopping datasource 初始化成功");
        return datasource;
    }
