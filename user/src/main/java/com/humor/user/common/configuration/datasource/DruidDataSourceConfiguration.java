package com.humor.user.common.configuration.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.humor.user.common.configuration.config.DruidDataSourceProperties;
...
public class DruidDataSourceConfiguration {
    ...
    public DataSource dataSource() {
        ...
        log.info("user datasource 初始化成功");
        return datasource;
    }
